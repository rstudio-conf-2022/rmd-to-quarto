...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: images/seaplane-headon.png
...
# {{< fa circle-right >}} Exercise 0 {background-color="#00403d" style="font-size: .7em"}
...
# {{< fa terminal >}} Exercise 1 {background-color="#00403d" style="font-size: .7em"}
