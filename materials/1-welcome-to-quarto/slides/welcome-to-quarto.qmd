...
1. Quarto and RMarkdown
2. What is a document? Rendering with Quarto
3. Authoring with Markdown
4. Expanding with Quarto
5. Computing
...
3. Look carefully through the source. What do you notice that's different from what it would look like in an R document? Discuss with your neighbor then post your answers to the discussion forum.
...
The $\TeX$ will be rendered by MathJax by default but other options are available.
...
# Structure, Format, Content, and Appearance


# Exercise 3 {background-color="#00403d" style="font-size: .7em"}
...
- [Wizard of Oz Gif](https://giphy.com/gifs/wizard-of-oz-3L8k2sJ2DwEZG)
